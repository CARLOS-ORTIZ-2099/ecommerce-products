...
export const Carrusel = () => {
  ...
  const [imageHeight, setImageHeight] = useState("646px");
          ...
          <div className="carousel-item active">
            <Link to="/productos/1">
              <img
                src={
                  windowWidth <= 500
                    ? "https://home.ripley.com.pe/minisitios/home/slider/24/05/06/7m.webp?v3"
          ...
          <div className="carousel-item">
            <Link to="/productos/2">
              <img
                src={
                  windowWidth <= 500
                    ? "https://home.ripley.com.pe/minisitios/home/slider/24/05/06/2m.webp?v2"
          ...
          <div className="carousel-item">
            <Link to="/productos/3">
              <img
                src={
                  windowWidth <= 500
                    ? "https://home.ripley.com.pe/minisitios/home/slider/24/05/06/4m.webp?v01"
          ...
          <div className="carousel-item">
            <Link to="/productos/8">
              <img
                src={
                  windowWidth <= 500
                    ? "https://home.ripley.com.pe/minisitios/home/slider/24/05/06/8m.webp?v01"
